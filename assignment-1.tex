...
problem 1 (b), execute the function \texttt{problem1d()}.

From the UNIX command-line, you can produce an output file and PDF by running

\begin{verbatim}
$ Rscript -e 'pdf("problem1b.pdf"); source("assignment-1.R"); problem1b()' \
    > problem1b.out
\end{verbatim}
This will produce \texttt{problem1b.out} and \texttt{problem1b.pdf} if anything
is plotted.
