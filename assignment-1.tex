...
for all $t$. Instead, we just use the original function and instead calculate
$c$ to normalize the PDF of the triangle function. See the code for more
details, or the algorithm \vref{algorithm:rtriangle}.

In \cite{STEIN20091143} there is another method to do this.
