...
A plot can be seen in figure \vref{plot.2a}.
...
\problem{2 (b)}
For $f(x) = c(x+1)^2$ with $x=0,1,2,3$ we have the sum $c+4c+9c+16c=30c$. To make
...
\verbatiminput{ex1-code/problem-3.R}

An example run produced
\verbatiminput{ex1-code/problem-3.out}
